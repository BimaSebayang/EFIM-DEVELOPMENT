package id.co.roxas.efim.core.dao;
...
import id.co.roxas.efim.core.entity.procacclaim.ProcInformation;
import id.co.roxas.efim.core.entity.procacclaim.pk.ProcInformationPk;
