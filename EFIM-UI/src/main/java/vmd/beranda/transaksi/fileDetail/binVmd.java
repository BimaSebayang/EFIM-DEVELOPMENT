...
public class binVmd extends BaseVmd implements Serializable{

	private static final long serialVersionUID = 6375771714451842329L;
	...
	public void caseChange(@BindingParam("caseMethod") String caseMethod) {
		...
		WsResponse response = restTemplateLib.getResultWs("/UserEfimDbCompCtl/SensitiveSearch/"+BIN, bodyInfo, "post",
	...
	@Command("mouseOverButtonUndo")
	public void mouseOverButtonUndo(@BindingParam("comp") String comp,
			@ContextParam(ContextType.BIND_CONTEXT) BindContext ctx) {
	...
	@Command("mouseOutButtonUndo")
	public void mouseOutButtonUndo(@BindingParam("comp") String comp,
			@ContextParam(ContextType.BIND_CONTEXT) BindContext ctx) {
	...
	@Command("changeUndo")
	public void changeUndo(@BindingParam("comp") String comp) {
		TblEfimDbDto tblEfimDbDto = new TblEfimDbDto();
		tblEfimDbDto.setFileIdReff(comp);
		...
		WsResponse wsResponse = new RestTemplateLib().getResultWs("/TambahCompCtl/Restore", tblEfimDbDto, "Post", new String[]{});		
	...
	public void forLov(String comp, String url) {
		callLovVmd(url , new MapperLovInformation("file_id_reff", comp), new MapperLovInformation("file_type", BIN)
