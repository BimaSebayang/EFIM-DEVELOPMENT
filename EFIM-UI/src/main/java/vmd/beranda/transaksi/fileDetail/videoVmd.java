...
public class videoVmd extends BaseVmd implements Serializable{
	private static final long serialVersionUID = -6079535789943631765L;
	...
	public void caseChange(@BindingParam("caseMethod") String caseMethod) {
		...
		WsResponse response = restTemplateLib.getResultWs("/UserEfimDbCompCtl/SensitiveSearch/"+VIDEO, bodyInfo, "post",
	...
	public void forLov(String comp, String url) {
		callLovVmd(url , new MapperLovInformation("file_id_reff", comp), new MapperLovInformation("file_type", VIDEO)
	...
	public void loadList() {
		...
		tempTblEfim.put("fileType", VIDEO);
